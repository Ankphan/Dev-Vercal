...
import Layout from '@/src/navigation/layout'; // Ensure this path is correct
	...
	return (
		<Layout>
			<VStack
				spacing={8}
				align="left"
				background="linear-gradient(90deg, rgba(220, 220, 255, 1) 9%, rgba(250, 220, 255, 1) 60%, rgba(230, 230, 255, 1) 72%)"
				pt={4}
				pb={4}
				pr={8}
				pl={8}
